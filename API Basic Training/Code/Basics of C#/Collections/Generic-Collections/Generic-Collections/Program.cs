...
class Program
{
    ...
    static void ListExample()
    {
        ...
        numbers.Add(6);
        Console.Write("After adding 6: ");
        PrintList(numbers);

        numbers.AddRange(new int[] { 7, 8, 9 });
        Console.Write("After adding 7, 8, 9: ");
        PrintList(numbers);

        // Removing elements from the List
        Console.WriteLine("Removing elements from the List:");
        numbers.Remove(3);
        ...
        Console.WriteLine("Accessing elements in the List:");
